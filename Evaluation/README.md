...
The results of the queries below can be found in the notebook [here](https://github.com/DeperiasKerre/qcl_Onto/blob/main/Evaluation/sparql_queries.ipynb) and the comparison with the actual data values [here] 
