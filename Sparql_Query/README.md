...
The results of the queries below can be found in the notebook here: ![Note Book](https://github.com/DeperiasKerre/qcl_Onto/blob/main/Sparql_Query/sparql_queriesv2.ipynb)     
CQ 1.1:  
CQ 1.2:
